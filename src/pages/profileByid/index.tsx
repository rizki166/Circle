...
import { getProfileById } from "../../lib/api/call/profile";

const ProfilePagesById = () => {
    ...
    async function getProfile() {
        try {
            const { data } = await getProfileById(Number(1));
            setProfile(data.data);
            // console.log(res.data.data, "ini profile");
        } catch (error) {
            console.log(error);
        }
    }
        ...
        <Box bgcolor={'#2d2d2d'} width={'100%'}>
            <Box  >
                ...
                <Box display={'flex'} flexDirection={'column'}  >
                    ...
                    <img src={`http://localhost:5000/uploads/${profile?.cover}`} alt="cover" style={{ maxWidth: "100%", height: "160px", borderRadius: "10px", objectFit: "cover" }} />
...
export default ProfilePagesById;
